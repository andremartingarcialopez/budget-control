...
export function BudgetTracker() {
    ...
    return (
        <div className="p-5 mx-2 bg-white shadow-2xl shadow-gray-400 rounded-xl mt-5 flex flex-col md:flex-row max-w-4xl justify-evenly items-center ">
            ...
            <div className="flex w-full md:w-100 flex-col space-y-2 mt-10 md:mt-0">
